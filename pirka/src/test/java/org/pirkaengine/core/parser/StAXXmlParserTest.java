...
public class StAXXmlParserTest {
	...
	public void parse_Simple() throws ParseException {
		...
		assertThat(actual.getFragments(),
				is(expected(Fragment.create(0, Fragment.Type.TEXT).build())));
	...
	public void parse_Expression() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(20, Fragment.Type.TEXT).build(),
						Fragment.create(13, Fragment.Type.EXPRESSION).build(),
	...
	public void parse_Expression_テキスト混在() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(26, Fragment.Type.TEXT).build(),
						Fragment.create(19, Fragment.Type.EXPRESSION).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_Expression_テキスト混在2() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(47, Fragment.Type.TEXT).build(),
						Fragment.create(40, Fragment.Type.EXPRESSION).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_Expression_テキスト混在3() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(22, Fragment.Type.TEXT).build(),
						Fragment.create(15, Fragment.Type.EXPRESSION).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_Content() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(85, Fragment.Type.TEXT).build(),
						Fragment.create(79, Fragment.Type.TAG_END).build(),
						Fragment.create(68, Fragment.Type.TAG_BODY).build(),
						Fragment.create(44, Fragment.Type.TAG_START)
								.append("content", "text").build(), Fragment
	...
	public void parse_If() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(67, Fragment.Type.TEXT).build(),
						Fragment.create(63, Fragment.Type.TAG_END).build(),
						Fragment.create(60, Fragment.Type.TAG_BODY).build(),
						Fragment.create(44, Fragment.Type.TAG_START)
								.append("if", "foo").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	...
	public void parse_If_Expression() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(70, Fragment.Type.TEXT).build(),
						Fragment.create(66, Fragment.Type.TAG_END).build(),
						Fragment.create(60, Fragment.Type.EXPRESSION).build(),
						Fragment.create(44, Fragment.Type.TAG_START)
								.append("if", "foo").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	...
	public void parse_For_Expression() throws ParseException {
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(71, Fragment.Type.EXPRESSION).build(),
						Fragment.create(44, Fragment.Type.TAG_START)
								.append("for", "item in items").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_For2_Expression() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(126, Fragment.Type.TEXT).build(),
						Fragment.create(122, Fragment.Type.TAG_END).build(),
						Fragment.create(115, Fragment.Type.TEXT).build(),
						Fragment.create(102, Fragment.Type.EXPRESSION).build(),
						Fragment.create(89, Fragment.Type.TEXT).build(),
						Fragment.create(77, Fragment.Type.EXPRESSION).build(),
						Fragment.create(71, Fragment.Type.TEXT).build(),
						Fragment.create(44, Fragment.Type.TAG_START)
								.append("for", "item in items").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	...
	public void parse_Escape() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(Fragment.create(16, Fragment.Type.TEXT).build(),
						Fragment.create(14, Fragment.Type.ESCAPE).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_Escape_WithHTMLEscape() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(Fragment.create(23, Fragment.Type.TEXT).build(),
						Fragment.create(21, Fragment.Type.ESCAPE).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_EmptyTag() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(24, Fragment.Type.TEXT).build(),
						Fragment.create(17, Fragment.Type.EXPRESSION).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_ForNest() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(116, Fragment.Type.TEXT).build(),
						Fragment.create(112, Fragment.Type.TAG_END).build(),
						Fragment.create(105, Fragment.Type.TAG_END).build(),
						Fragment.create(103, Fragment.Type.TAG_BODY).build(),
						Fragment.create(78, Fragment.Type.TAG_START)
								.append("content", "item").build(),
						Fragment.create(51, Fragment.Type.TAG_START)
								.append("for", "item in items").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_START)
								.append(PrkAttribute.ATTR.name,
										PrkAttribute.ATTR.name)
								.appendPrkAttrs(
										Fragment.attr("attr.href", "url"),
										Fragment.attr("attr.title", "title"))
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_START)
								.append(PrkAttribute.ATTR.name,
										PrkAttribute.ATTR.name)
								.appendPathAttrs(
										Fragment.attr("path.href", "index.html"))
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkAttribute.ATTR.name,
										PrkAttribute.ATTR.name)
								.appendPrkAttrs(
										Fragment.attr("attr.src", "img_src"))
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkAttribute.ATTR.name,
										PrkAttribute.ATTR.name)
								.appendPrkAttrs(
										Fragment.attr("attr.selected.when",
												"cond"))
								.appendAttrs(
										Fragment.attr("selected", "selected"))
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_prk_component() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(Fragment.create(76, Fragment.Type.TEXT).build(),
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
	...
	public void parse_prk_component_withParam() throws ParseException {
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkElement.COMPONENT.name, "plugin")
								.appendAttrs(Fragment.attr("name", "FooPlugin"))
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkElement.COMPONENT.name, "plugin")
								.appendAttrs(
										Fragment.attr("name", "FooPlugin"),
										Fragment.attr("var", "foo")).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_prk_component_withParams_and_for() throws ParseException {
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(143, Fragment.Type.TAG_START)
								.append("for", "item in items").build(),
						Fragment.create(133, Fragment.Type.TEXT).build(),
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkElement.COMPONENT.name, "plugin")
	...
	public void parse_prk_include() throws ParseException {
		...
		assertThat(
				...
				is(expected(Fragment.create(76, Fragment.Type.TEXT).build(),
						Fragment.create(45, Fragment.Type.TAG_EMPTY_ELEMENTS)
								.append(PrkElement.INCLUDE.name, "foo.html")
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_prk_extends() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(72, Fragment.Type.TAG_END).build(),
						Fragment.create(69, Fragment.Type.TAG_BODY).build(),
						Fragment.create(0, Fragment.Type.TAG_START)
								.append(PrkAttribute.EXTENDS.name, "foo.html")
								.build())));
		assertThat(actual.getText().toString(), is(text));
	}
		...
		assertThat(
				...
				is(expected(
						...
						Fragment.create(45, Fragment.Type.FUNCTIONS)
								.appendPrkAttrs(
										Fragment.attr("class", "foo.bar.Poo"),
										Fragment.attr("name", "")).build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_prk_block() throws ParseException {
		...
		assertThat(
				...
				is(expected(
						Fragment.create(75, Fragment.Type.TEXT).build(),
						Fragment.create(69, Fragment.Type.TAG_END).build(),
						Fragment.create(45, Fragment.Type.TAG_START)
								.append(PrkAttribute.BLOCK.name, "header")
								.build(), Fragment
								.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
	...
	public void parse_Expression_and_prk_block() throws ParseException {
		...
		assertThat(
				actual.getFragments(),
				is(expected(
						Fragment.create(87, Fragment.Type.TEXT).build(),
						Fragment.create(80, Fragment.Type.TAG_END).build(),
						Fragment.create(76, Fragment.Type.TEXT).build(),
						Fragment.create(69, Fragment.Type.EXPRESSION).build(),
						Fragment.create(66, Fragment.Type.TEXT).build(),
						Fragment.create(45, Fragment.Type.TAG_START)
								.append(PrkAttribute.BLOCK.name, "id").build(),
						Fragment.create(0, Fragment.Type.TEXT).build())));
		assertThat(actual.getText().toString(), is(text));
	}
